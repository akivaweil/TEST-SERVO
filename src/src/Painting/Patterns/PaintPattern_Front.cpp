...
bool executePaintPatternFront(float speed, float accel) {
    ...
    // --- Perform Rotation to Front Side Using actionRotateTo ---
    ...
    if (patternType == 0) { // --- Up/Down Pattern --- 
        Serial.println("  Executing Up/Down Pattern Logic for Front...");
        ...
        Serial.println("  Executing Sideways Pattern Logic for Front...");
